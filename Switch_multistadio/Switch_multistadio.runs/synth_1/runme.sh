...
HD_PWD='C:/Users/corra/Desktop/Digital Sysetms Architecture Projects/Switch_multistadio/Switch_multistadio.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Omega_network.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Omega_network.tcl
