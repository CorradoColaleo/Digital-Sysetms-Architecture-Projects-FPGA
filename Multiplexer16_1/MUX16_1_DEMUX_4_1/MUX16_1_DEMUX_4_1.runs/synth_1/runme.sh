...
HD_PWD='C:/Users/corra/Desktop/Elaborato/MUX16_1_DEMUX_4_1/MUX16_1_DEMUX_4_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RETE_DI_INTERCONNESSIONE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RETE_DI_INTERCONNESSIONE.tcl
