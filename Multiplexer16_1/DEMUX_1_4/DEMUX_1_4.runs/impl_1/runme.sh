...
HD_PWD='C:/Users/corra/Desktop/Elaborato/DEMUX_1_4/DEMUX_1_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DEMUX_1_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DEMUX_1_4.tcl -notrace
