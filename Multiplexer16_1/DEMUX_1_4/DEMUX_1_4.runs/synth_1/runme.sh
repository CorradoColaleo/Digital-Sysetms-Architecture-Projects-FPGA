...
HD_PWD='C:/Users/corra/Desktop/Elaborato/DEMUX_1_4/DEMUX_1_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DEMUX_1_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DEMUX_1_4.tcl
