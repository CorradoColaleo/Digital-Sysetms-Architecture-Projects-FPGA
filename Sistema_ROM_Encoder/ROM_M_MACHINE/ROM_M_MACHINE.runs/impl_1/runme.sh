...
HD_PWD='C:/VivadoProject/Progetto2/ROM_M_MACHINE/ROM_M_MACHINE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ROM_M_MACHINE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ROM_M_MACHINE.tcl -notrace
