...
HD_PWD='C:/VivadoProject/Progetto2/ROM_M_MACHINE/ROM_M_MACHINE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROM_M_MACHINE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROM_M_MACHINE.tcl
